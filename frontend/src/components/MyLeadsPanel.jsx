        ...
        {myLeads.map((lead) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap gap-x-2.5 gap-y-1 mb-3 text-[11px] text-dark-400">
                {lead.phone && (
              ...
              {lead.last_input_text && (
                <p className="text-[11px] text-dark-300 mb-3 leading-snug bg-dark-950/40 border border-dark-800 rounded-lg px-2.5 py-1.5">
                  💬 {lead.last_input_text}
                </p>
              )}
